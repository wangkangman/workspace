...
/*-----------------------------------------------------------------*/
#define FDL_DFLCTL             (*(volatile u8 *)(0x0090))

/*-----------------------------------------------------------------*/
/* Port register define                                            */
/*-----------------------------------------------------------------*/
#define PORT_PM1               (*(volatile u8 *)(0xFF21))
#define PORT_PM2               (*(volatile u8 *)(0xFF22))
#define PORT_PM4               (*(volatile u8 *)(0xFF24))
#define PORT_PM6               (*(volatile u8 *)(0xFF26))
#define PORT_PD1               (*(volatile u8 *)(0xFF01))
#define PORT_PD2               (*(volatile u8 *)(0xFF02))
#define PORT_PD2_bit           (*(volatile __bitf_T *)(0xFF02))


#define PORT_PD4               (*(volatile u8 *)(0xFF04))
#define PORT_PD6               (*(volatile u8 *)(0xFF06))
#define PORT_PD12              (*(volatile u8 *)(0xFF0C))
#define PORT_PD13              (*(volatile u8 *)(0xFF0D))
#define PORT_PU1               (*(volatile u8 *)(0x0031))
#define PORT_PU4               (*(volatile u8 *)(0x0034))
#define PORT_PU12              (*(volatile u8 *)(0x003C))
#define PORT_PIM1              (*(volatile u8 *)(0x0041))
#define PORT_POM1              (*(volatile u8 *)(0x0051))
#define PORT_POM4              (*(volatile u8 *)(0x0054))
#define PORT_PMC1              (*(volatile u8 *)(0x0061))
#define PORT_PMC4              (*(volatile u8 *)(0x0064))
#define PORT_ADPC              (*(volatile u8 *)(0x0076))
#define PORT_PIOR              (*(volatile u8 *)(0x0077))

/*-----------------------------------------------------------------*/
/* Clock and reset register define                                 */
/*-----------------------------------------------------------------*/
#define CLK_CMC                (*(volatile u8 *)(0xFFA0))
#define CLK_CSC                (*(volatile u8 *)(0xFFA1))
#define CLK_OSTC               (*(volatile u8 *)(0xFFA2))
#define CLK_OSTS               (*(volatile u8 *)(0xFFA3))
#define CLK_CKC                (*(volatile u8 *)(0xFFA4))
#define CLK_CKS0               (*(volatile u8  *)0xFFA5)
#define CLK_HIOTRM             (*(volatile u8 *)(0x00A0))
#define CLK_HOCODIV            (*(volatile u8 *)(0x00A8))
#define CLK_PER0               (*(volatile u8 *)(0x00F0))
#define CLK_OSMC               (*(volatile u8 *)(0x00F3))
#define RST_RESF               (*(volatile u8 *)(0xFFA8))

/*-----------------------------------------------------------------*/
/* Watchdog register define                                        */
/*-----------------------------------------------------------------*/
#define WDT_WDTE               (*(volatile u8 *)(0xFFAB))

/*-----------------------------------------------------------------*/
/* Timer register define                                           */
/*-----------------------------------------------------------------*/
#define TIM_TPS0               (*(volatile u16 *)(0x01B6))
#define TIM_TMR00              (*(volatile u16 *)(0x0190))
#define TIM_TMR01              (*(volatile u16 *)(0x0192))
#define TIM_TMR02              (*(volatile u16 *)(0x0194))
#define TIM_TMR03              (*(volatile u16 *)(0x0196))
#define TIM_TSR0               (*(volatile u16 *)(0x01A0))
#define TIM_TSR1               (*(volatile u16 *)(0x01A2))
#define TIM_TSR2               (*(volatile u16 *)(0x01A4))
#define TIM_TSR3               (*(volatile u16 *)(0x01A6))
#define TIM_TE0                (*(volatile u16 *)(0x01B0))
#define TIM_TS0                (*(volatile u16 *)(0x01B2))
#define TIM_TT0                (*(volatile u16 *)(0x01B4))
#define TIM_TIS0               (*(volatile u8 *)(0x0074))
#define TIM_TOE0               (*(volatile u16 *)(0x01BA))
#define TIM_TO0                (*(volatile u16 *)(0x01B8))
#define TIM_TOL0               (*(volatile u16 *)(0x01BC))
#define TIM_TOM0               (*(volatile u16 *)(0x01BE))
#define TIM_NFEN1              (*(volatile u8 *)(0x0071))
#define TIM_TDR00              (*(volatile u16 *)(0xFF18))
#define TIM_TDR01              (*(volatile u16 *)(0xFF1A))
#define TIM_TDR02              (*(volatile u16 *)(0xFF64))
#define TIM_TDR03              (*(volatile u16 *)(0xFF66))
#define TIM_TCR00              (*(volatile u16 *)(0x0180))
#define TIM_TCR01              (*(volatile u16 *)(0x0182))
#define TIM_TCR02              (*(volatile u16 *)(0x0184))
#define TIM_TCR03              (*(volatile u16 *)(0x0186))

/*-----------------------------------------------------------------*/
/* Uart register define                                            */
/*-----------------------------------------------------------------*/
#define UART_SPS0              (*(volatile u16 *)(0x0126))
#define UART_SMR00             (*(volatile u16 *)(0x0110))
#define UART_SMR01             (*(volatile u16 *)(0x0112))
#define UART_SCR00             (*(volatile u16 *)(0x0118))
#define UART_SCR01             (*(volatile u16 *)(0x011A))
#define UART_SDR00             (*(volatile u16 *)(0xFF10))
#define UART_SDR01             (*(volatile u16 *)(0xFF12))
#define UART_SIR00             (*(volatile u16 *)(0x0108))
#define UART_SIR01             (*(volatile u16 *)(0x010A))
#define UART_SSR00             (*(volatile u16 *)(0x0100))
#define UART_SSR01             (*(volatile u16 *)(0x0102))
#define UART_SS0               (*(volatile u16 *)(0x0122))
#define UART_ST0               (*(volatile u16 *)(0x0124))
#define UART_SE0               (*(volatile u16 *)(0x0120))
#define UART_SOE0              (*(volatile u16 *)(0x012A))
#define UART_SO0               (*(volatile u16 *)(0x0128))
#define UART_SOL0              (*(volatile u16 *)(0x0134))
#define UART_SSC0              (*(volatile u16 *)(0x0138))
#define UART_NFEN0             (*(volatile u16 *)(0x0070))
#define UART_TXD0              (*(volatile u8 *)(0xFF10))
#define UART_RXD0              (*(volatile u8 *)(0xFF12))

/*-----------------------------------------------------------------*/
/* ADC register define                                             */
/*-----------------------------------------------------------------*/
#define ADC_ADM0               (*(volatile u8 *)(0xFF30))
#define ADC_ADM1               (*(volatile u8 *)(0xFF32))
#define ADC_ADM2               (*(volatile u8 *)(0x0010))
#define ADC_ADCR               (*(volatile u16 *)(0xFF1E))
#define ADC_ADS                (*(volatile u8 *)(0xFF31))
#define ADC_ADUL               (*(volatile u8 *)(0x0011))
#define ADC_ADLL               (*(volatile u8 *)(0x0012))
#define ADC_ADTES              (*(volatile u8 *)(0x0013))

/*-----------------------------------------------------------------*/
/* Interrupt register define                                       */
/*-----------------------------------------------------------------*/
#define INT_IF0L               (*(volatile u8 *)(0xFFE0))
#define INT_IF0H               (*(volatile u8 *)(0xFFE1))
#define INT_IF1L               (*(volatile u8 *)(0xFFE2))
#define INT_MK0L               (*(volatile u8 *)(0xFFE4))
#define INT_MK0H               (*(volatile u8 *)(0xFFE5))
#define INT_MK1L               (*(volatile u8 *)(0xFFE6))
#define INT_PR00L              (*(volatile u8 *)(0xFFE8))
#define INT_PR00H              (*(volatile u8 *)(0xFFE9))
#define INT_PR01L              (*(volatile u8 *)(0xFFEA))
#define INT_PR10L              (*(volatile u8 *)(0xFFEC))
#define INT_PR10H              (*(volatile u8 *)(0xFFED))
#define INT_PR11L              (*(volatile u8 *)(0xFFEE))
#define INT_EGP0               (*(volatile u8 *)(0xFF38))
#define INT_EGN0               (*(volatile u8 *)(0xFF39))
