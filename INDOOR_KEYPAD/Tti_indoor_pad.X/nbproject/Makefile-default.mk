...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Tti_indoor_pad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=source/clkset.c source/keeloq.c source/ledTask.c source/main.c source/remote.c source/timer.c source/usart.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/source/clkset.p1 ${OBJECTDIR}/source/keeloq.p1 ${OBJECTDIR}/source/ledTask.p1 ${OBJECTDIR}/source/main.p1 ${OBJECTDIR}/source/remote.p1 ${OBJECTDIR}/source/timer.p1 ${OBJECTDIR}/source/usart.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/source/clkset.p1.d ${OBJECTDIR}/source/keeloq.p1.d ${OBJECTDIR}/source/ledTask.p1.d ${OBJECTDIR}/source/main.p1.d ${OBJECTDIR}/source/remote.p1.d ${OBJECTDIR}/source/timer.p1.d ${OBJECTDIR}/source/usart.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/source/clkset.p1 ${OBJECTDIR}/source/keeloq.p1 ${OBJECTDIR}/source/ledTask.p1 ${OBJECTDIR}/source/main.p1 ${OBJECTDIR}/source/remote.p1 ${OBJECTDIR}/source/timer.p1 ${OBJECTDIR}/source/usart.p1

# Source Files
SOURCEFILES=source/clkset.c source/keeloq.c source/ledTask.c source/main.c source/remote.c source/timer.c source/usart.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Tti_indoor_pad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/source/ledTask.p1: source/ledTask.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/source" 
	@${RM} ${OBJECTDIR}/source/ledTask.p1.d 
	@${RM} ${OBJECTDIR}/source/ledTask.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/source/ledTask.p1  source/ledTask.c 
	@-${MV} ${OBJECTDIR}/source/ledTask.d ${OBJECTDIR}/source/ledTask.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/source/ledTask.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Tti_indoor_pad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Tti_indoor_pad.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=+asm,+asmfile,-speed,+space,-debug,-local --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"      --ram=default,-160-16f  $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/Tti_indoor_pad.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Tti_indoor_pad.X.${IMAGE_TYPE}.hex 
