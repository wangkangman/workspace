...
#include "global.h"
/**
  * @brief  Independent watchdog register define 
  */
#define IWDG_REG_BASE   (0x50E0)
#define IWDG_KR         (*(volatile U08ET *)(IWDG_REG_BASE+0x00))
#define IWDG_PR         (*(volatile U08ET *)(IWDG_REG_BASE+0x01))
#define IWDG_RLR        (*(volatile U08ET *)(IWDG_REG_BASE+0x02))
/**
  * @brief  Port register define
  */
...
/**
  ...
  */
#define SPI_REG_BASE    (0x5200)
#define SPI_CR1         (*(volatile U08ET *)(SPI_REG_BASE+0x00))
#define SPI_CR2         (*(volatile U08ET *)(SPI_REG_BASE+0x01))
#define SPI_ICR         (*(volatile U08ET *)(SPI_REG_BASE+0x02))
#define SPI_SR          (*(volatile U08ET *)(SPI_REG_BASE+0x03))
#define SPI_DR          (*(volatile U08ET *)(SPI_REG_BASE+0x04))
#define SPI_CRCPR       (*(volatile U08ET *)(SPI_REG_BASE+0x05))
#define SPI_RXCRCR      (*(volatile U08ET *)(SPI_REG_BASE+0x06))
#define SPI_TXCRCR      (*(volatile U08ET *)(SPI_REG_BASE+0x07))
...
/**
  * @brief  port contrl define
  */
#define HIGH (1)
#define LOW  (0)

#define PORT_READ(PORT, PIN)        (((*(volatile U08ET *)(0x5001 + (PORT * 5))) & (0x1 << PIN)) ? 1 : 0)
#define PORT_SET(PORT, PIN, STATUS) (STATUS ? ((*(volatile unsigned char *)(0x5000 + (PORT *5))) |= (0x1 << PIN)) : \
																							((*(volatile unsigned char *)(0x5000 + (PORT *5))) &= (~(0x1 << PIN))))
